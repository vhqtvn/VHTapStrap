...
namespace LibVHTapStrap
{
    ...
    static class VKExt
    {
        private static VK[] createChar2VK()
        {
            var char2vk = new VK[256];
            for (int i = 0; i < 256; ++i)
            {
                char2vk[i] = VK.VK_NONE;
            }
            char c;
            VK vk;
            for (c = 'a', vk = VK.VK_A; c <= 'z'; c++, vk++)
            {
                char2vk[c] = vk;
            }
            for (c = 'A', vk = VK.VK_A; c <= 'Z'; c++, vk++)
            ...
            char2vk['('] = VK.VK_9;
            char2vk[')'] = VK.VK_0;
            char2vk['-'] = VK.OEM_MINUS;
            char2vk['_'] = VK.OEM_MINUS;
            char2vk['='] = VK.OEM_PLUS;
            char2vk['+'] = VK.OEM_PLUS;
            char2vk['['] = VK.OEM_4;
            char2vk['{'] = VK.OEM_4;
            ...
            char2vk['\''] = VK.OEM_7;
            char2vk['"'] = VK.OEM_7;
            char2vk[','] = VK.OEM_COMMA;
            char2vk['<'] = VK.OEM_COMMA;
            char2vk['.'] = VK.OEM_PERIOD;
            char2vk['>'] = VK.OEM_PERIOD;
            char2vk['/'] = VK.OEM_2;
            char2vk['?'] = VK.OEM_2;
            char2vk['`'] = VK.OEM_3;
        ...
        private static VK[] char2vk = createChar2VK();

        private static bool[] createChar2Shift()
        {
            var char2shift = new bool[256];
            for (int i = 0; i < 256; ++i)
            {
                char2shift[i] = false;
            }
        ...
        private static bool[] char2shift = createChar2Shift();

        public static ushort Into(this VK vk)
        {
            return (ushort)vk;
        }

        public static VK? ToVK(this char c)
        {
            VK vk = char2vk[c];
            if (vk == VK.VK_NONE)
            {
        ...
        public static bool IsVKShifted(this char c)
        {
            return char2shift[c];
        }
    }
